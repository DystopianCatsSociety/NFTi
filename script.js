...
var Dust = function(config) {
    ...
    this.color = config.color || color(random(170, 190), random(135, 155), random(95, 115)); //color(179, 146, 105)
};
...
var BabyYoda = function(config) {
    ...
    this.useTheForce = function(force) {
        this.force = force;
        //change eye color and stop blinking
        if(force) {
            this.blink = false;
    ...
    this.how = function() {
        pushMatrix();
            ...
            pushStyle();
                ...
                textAlign(LEFT, TOP);
                textSize(16);
                text("Move the mouse to make Yoda look around.\n\nClick on the screen to move Yoda.\n\nPress the UP key to use the force. If you run out of force Yoda will need to sleep.\n\nIf you are idle for too long... Yoda will randomly look around, move, use the force, and occasionally sleep.", 140, 20, 340, 360);
